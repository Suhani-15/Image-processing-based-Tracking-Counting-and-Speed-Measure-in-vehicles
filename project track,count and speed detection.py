...
while True:
    ...
    cv2.rectangle(frame, (0, 0), (350, 120), yellow_color, -1)
    ...
    cv2.putText(frame, ('Total Count - ' + str(len(counter_up)+len(counter_down))), (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.5, text_color, 1, cv2.LINE_AA)
